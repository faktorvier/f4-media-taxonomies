...
class Helpers {
	 ...
	 */
	public static function get_terms_hierarchical($taxonomy, $args = array(), $parent = 0, $level = 1, $parents = array()) {
		$terms_all = array();
		...
		foreach($terms as $term) {
			...
			$terms_sub = self::get_terms_hierarchical($taxonomy, $args, $term->term_id, $level + 1, $term_parents);
